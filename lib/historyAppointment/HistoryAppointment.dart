...
//
//     final historyAppointment = historyAppointmentFromJson(jsonString);

import 'dart:convert';

List<HistoryAppointment> historyAppointmentFromJson(String str) => List<HistoryAppointment>.from(json.decode(str).map((x) => HistoryAppointment.fromJson(x)));

String historyAppointmentToJson(List<HistoryAppointment> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class HistoryAppointment {
  ...
  factory HistoryAppointment.fromJson(Map<String, dynamic> json) => HistoryAppointment(
