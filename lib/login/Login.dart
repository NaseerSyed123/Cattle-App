class Login {
  ...
  set loginUser(LoginUser loginUser) => _loginUser = loginUser;

  Login.fromJson(Map<String, dynamic> json) {
    _loginUser = json['loginUser'] != null
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._loginUser != null) {
      data['loginUser'] = this._loginUser.toJson();
    }
    return data;
  }
}
...
class LoginUser {
  ...
  Null get reffarlNo => _reffarlNo;
  set reffarlNo(Null reffarlNo) => _reffarlNo = reffarlNo;
