class Mobile {
  ...
  Mobile({User user, String success}) {
    this._user = user;
...
class User {
  ...
  Null get apiToken => _apiToken;
  set apiToken(Null apiToken) => _apiToken = apiToken;
  ...
  Null get pic => _pic;
  set pic(Null pic) => _pic = pic;
  Null get country => _country;
  set country(Null country) => _country = country;
  ...
  Null get lat => _lat;
  set lat(Null lat) => _lat = lat;
  Null get long => _long;
  set long(Null long) => _long = long;
  ...
  Null get coordinate => _coordinate;
  set coordinate(Null coordinate) => _coordinate = coordinate;
