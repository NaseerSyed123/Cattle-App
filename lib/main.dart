...
import 'Screen/B1_HomeScreen/B1_Home/GuestScreen.dart';
import 'Screen/OpeningApps/LoginOrLoginScreen/ChoseLoginOrLoginScreen.dart';
import 'Screen/OpeningApps/OnBoarding/OnBoarding.dart';
import 'package:cattle_app/AppLayer/Provider.dart' as pro;
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void NavigatorPage() {
    if (_checkUser) {
      ...
      Navigator.of(context).pushReplacement(
          PageRouteBuilder(pageBuilder: (_, __, ___) => BottomTabbed()));
    }
  }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Hero(
                        tag: "Treva",
                        child: Text(
                          AppLocalizations.of(context).tr('My Cattle App'),
                          style: TextStyle(
